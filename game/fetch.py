   ...
   .catch(err => {
    ...
    async def post(self, url, data=None):
        ...
        if self.is_emscripten:
            ...
            self.result = self.requests.post(url, json.dumps(data), headers={'Accept': 'application/json','Content-Type': 'application/json'}).text
        return self.result
    ...
    async def getLoginUser(self):
        ...
        if self.is_emscripten:
            ...
            self.result = self.requests.post(url).text
        return self.result
